...
image = tifffile.imread('/Users/oskar/Desktop/exp024gomb_SBSO_OPP_d5/raw_images/NM_SBSE_OPP_d5_2024_10_28__17_40_50__p5.tiff')
...
def categorise_pixels(channel_images, z, y_pixels, x_pixels):
    ...
    threshold_channel_0 = 0.8 * threshold_lines[0](z) + 0.05
    threshold_channel_1 = 0.85 * threshold_lines[1](z) + 0.0
    threshold_channel_3 = 1 * threshold_lines[3](z)    
        ...
        for x in range(x_pixels):
            for y in range(y_pixels):
                ...
                if channel_2_value < lower_black_threshold:
                    ...
                    categorised_image[y, x] = (100, 100, 100)
...
preprocessed_image = preprocess(desaturated_image)
