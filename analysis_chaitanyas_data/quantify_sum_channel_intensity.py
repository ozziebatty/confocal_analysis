...
output_csv_path = r"C:\Users\ob361\data\glucose_Bra_Sox2\channel_intensity_sums.csv"

days = '2-4'  # Set the days variable to the desired value
...
with open(output_csv_path, mode='a', newline='') as file:
    ...
    for root, _, files in os.walk(base_dir):
        for filename in files:
            ...
            channel_sums = [image[:, i, :, :].sum() for i in range(c)]
            row = [image_name, inverse, treatment, set_name, replicate, days] + channel_sums
            writer.writerow(row)
