...
if days == '2-5':
    base_dir = r"C:\Users\ob361\data\glucose_Bra_Sox2\Day 2 - 5\all_images_d2_to_d5"
if days == '2-4':
    base_dir = r"C:\Users\ob361\data\glucose_Bra_Sox2\Day 2 - 4\all_images_d2_to_d4"
if days == '3-4':  
    base_dir = r"C:\Users\ob361\data\glucose_Bra_Sox2\Day 3 - 4\all_images_d3_to_d4"


output_csv_path = r"C:\Users\ob361\data\glucose_Bra_Sox2\size.csv"
...
with open(output_csv_path, mode='a', newline='') as file:
    ...
    for root, _, files in os.walk(base_dir):
        for filename in files:
            ...
            dapi_mask = image[:, 0, :, :] > 10
            size = np.sum(dapi_mask, axis=(0, 1, 2)) 
            # Sum over Z, Y, X dimensions
            #print(f"Size: {size}")
            row = [image_name, inverse, treatment, set_name, replicate, days, size]
            writer.writerow(row)
